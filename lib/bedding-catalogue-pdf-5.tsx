...
export function BeddingCatalogueFive({
  groups,
  business,
  banking,
  logoDataUri,
  ...
  return (
    <Document title={`${business.name} - Bedding Catalogue 5`} author={business.name}>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.cover}>
          ...
          <Text style={styles.subtitle}>
            Edition 5 - Complete Bedding Range: Comforters, Quilt Sets, Bedsheets, Throws and Winter Blankets
          </Text>
        </View>
