...
const styles = StyleSheet.create({
  ...
  cardImage: { width: "100%", height: 108, objectFit: "contain" },
...
export function KitchenwareCatalogue({
  groups,
  business,
  banking,
  logoDataUri,
  ...
  return (
    <Document title={`${business.name} - Kitchenware Catalogue`} author={business.name}>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.cover}>
          ...
          <Text style={styles.title}>Kitchenware Catalogue</Text>
          <Text style={styles.subtitle}>
            Complete Kitchenware Range: Cookware Sets &amp; Pots, Bread Bins &amp; Canisters, Bakeware, Knives &amp;
            Cutlery, Utensil Sets, Food Warmers, Serving &amp; Tableware, Storage &amp; Organisers, Appliances and
            Kitchen Accessories
          </Text>
        </View>
