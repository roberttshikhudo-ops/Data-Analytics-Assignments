...
export interface BlanketsCatalogueProduct {
  name: string
  price: number
...
export interface BlanketsCatalogueSeriesGroup {
  title: string
  subtitle?: string
  products: BlanketsCatalogueProduct[]
}

export interface BlanketsCatalogueBusinessInfo {
  name: string
  tagline: string
  phone: string
  altPhone: string
...
export interface BlanketsCatalogueBankingInfo {
  bank: string
  accountName: string
...
export function BlanketsCatalogue({
  groups,
  business,
  banking,
  logoDataUri,
  ...
  groups: BlanketsCatalogueSeriesGroup[]
  business: BlanketsCatalogueBusinessInfo
  banking: BlanketsCatalogueBankingInfo
  ...
  return (
    <Document title={`${business.name} - Blanket Catalogue`} author={business.name}>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.cover}>
          ...
          <Text style={styles.title}>Blankets</Text>
          <Text style={styles.subtitle}>
            Warm, Soft 1Ply and 2Ply Winter Blankets for Every Home
          </Text>
        </View>
