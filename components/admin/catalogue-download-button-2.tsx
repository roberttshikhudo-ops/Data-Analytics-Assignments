...
export function CatalogueDownloadButtonTwo() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const res = await fetch("/api/admin/catalogue/bedding-2", {
        credentials: "include",
      })
      ...
      link.href = url
      link.download = "Agri-Hub-SA-Bedding-Catalogue-2.pdf"
  ...
  return (
    <Button variant="outline" onClick={handleDownload} disabled={isLoading}>
      ...
      {isLoading ? "Generating..." : "Bedding Catalogue 2"}
    </Button>
  )
}
