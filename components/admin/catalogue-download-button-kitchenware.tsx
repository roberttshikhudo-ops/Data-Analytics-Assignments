...
export function CatalogueDownloadButtonKitchenware() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const res = await fetch("/api/admin/catalogue/kitchenware", {
        credentials: "include",
      })
      ...
      link.href = url
      link.download = "Agri-Hub-SA-Kitchenware-Catalogue.pdf"
  ...
  return (
    <Button variant="outline" onClick={handleDownload} disabled={isLoading}>
      ...
      {isLoading ? "Generating..." : "Kitchenware Catalogue"}
    </Button>
  )
}
