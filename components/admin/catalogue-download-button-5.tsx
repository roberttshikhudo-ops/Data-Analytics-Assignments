...
export function CatalogueDownloadButtonFive() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const res = await fetch("/api/admin/catalogue/bedding-5", {
        credentials: "include",
      })
      ...
      link.href = url
      link.download = "Agri-Hub-SA-Bedding-Catalogue-5.pdf"
  ...
  return (
    <Button variant="outline" onClick={handleDownload} disabled={isLoading}>
      ...
      {isLoading ? "Generating..." : "Bedding Catalogue 5"}
    </Button>
  )
}
