...
export function CatalogueDownloadButtonBlankets() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const res = await fetch("/api/admin/catalogue/blankets", {
        credentials: "include",
      })
      ...
      link.href = url
      link.download = "Agri-Hub-Blankets.pdf"
  ...
  return (
    <Button variant="outline" onClick={handleDownload} disabled={isLoading}>
      ...
      {isLoading ? "Generating..." : "Blanket Catalogue"}
    </Button>
  )
}
