...
export function CatalogueDownloadButtonFleece() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const res = await fetch("/api/admin/catalogue/bedding-5?series=fleece", {
        credentials: "include",
      })
      ...
      link.href = url
      link.download = "Agri-Hub-SA-Fleece-Comforter-Catalogue.pdf"
  ...
  return (
    <Button variant="outline" onClick={handleDownload} disabled={isLoading}>
      ...
      {isLoading ? "Generating..." : "Fleece Comforter Catalogue"}
    </Button>
  )
}
