...
export function CatalogueDownloadButtonThrows() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const res = await fetch("/api/admin/catalogue/throws", {
        credentials: "include",
      })
      ...
      link.href = url
      link.download = "Agri-Hub-Throws-and-Flees.pdf"
  ...
  return (
    <Button variant="outline" onClick={handleDownload} disabled={isLoading}>
      ...
      {isLoading ? "Generating..." : "Agri Hub Throws & Flees"}
    </Button>
  )
}
